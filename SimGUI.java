...
class SimGUI {
	...
	/**
	 * The panel containing the first graph display.
	 */
	private Graph<City, Flight> graph = null;

	/**
	 * The panel containing the second graph display.
	 */
	private Graph<City, Flight> graph2 = null;

	/**
	 * The panel containing the first visual display.
	 */
	private VisualizationViewer<City, Flight> visServer = null;

	/**
	 * The panel containing the second visual display.
	 */
